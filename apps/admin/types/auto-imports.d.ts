...
declare global {
  ...
  const GlDropdownItem: typeof import('../src/global/components/gl-dropdown/index').GlDropdownItem
  const GlDropdownMenu: typeof import('../src/global/components/gl-dropdown/index').GlDropdownMenu
  ...
  const GlTabPanel: typeof import('../src/global/components/gl-tabs/index').GlTabPanel
  ...
  const V: typeof import('../src/global/enums/index').V
  ...
  const useMountEffect: typeof import('../src/global/hooks/use-mount-effect/index').useMountEffect
  ...
  const useResetData: typeof import('../src/global/hooks/use-reset-data/index').useResetData
...
declare global {
  // @ts-ignore
  export type { ScreenSizeKey, LangType, ThemeMode } from '../src/global/constants/index'
